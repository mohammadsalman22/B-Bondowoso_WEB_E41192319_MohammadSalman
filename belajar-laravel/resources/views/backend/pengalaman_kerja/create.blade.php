			...
			<div class="form">
				<form class="form-validate form-horizontal" id="pengalaman_kerja_form" method="POST" action="{{ route('pengalaman_kerja.store') }}">
					...
					<div class="form-group">
						...
						<div class="col-lg-10">
							<input class="form-group" id="nama" minlength="5"  type="text" name="nama" required />
						</div>
					</div>
					<div class="form-group">
						<label for="cname" class="control-label col-lg-2">Jabatan <span class="required">*</span></label>
						<div class="col-lg-10">
							<input class="form-group" id="jabatan" minlength="2"  type="text" name="jabatan" required />
						</div>
					</div>
					<div class="form-group">
						<label for="curl" class="control-label col-lg-2">Tahun Masuk <span class="required">*</span></label>
						<div class="col-lg-10">
							<input class="form-group" id="tahun_masuk" type="text" name="tahun_masuk" required />
						</div>
					</div>
					<div class="form-group">
						<label for="curl" class="control-label col-lg-2">Tahun Selesai <span class="required">*</span></label>
						<div class="col-lg-10">
							<input class="form-group" id="tahun_keluar" type="text" name="tahun_keluar" required />
						</div>
					</div>
					<div class="form-group">
